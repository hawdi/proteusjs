...
class Reporter {
  constructor (options) {
    ...
    if(!options.reporter.console.custom) options.reporter.console && this.initConsole(options);
    else options.reporter.consoleReporter = options.reporter.console.custom;
